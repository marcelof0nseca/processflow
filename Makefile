...
test: all
	...
	@echo ""
	@echo "=========================================================="
	@echo " 8. ERROS NAO-FATAIS - cada um imprime mensagem e CONTINUA"
	@echo "=========================================================="
	@echo "\$$ ./$(BIN) teste_erros.pf"
	@./$(BIN) teste_erros.pf
	@echo ""
	@echo "=========================================================="
	@echo " 9. WORKFLOW SEM 'exit' - processa ate o fim e encerra limpo"
	@echo "=========================================================="
	@echo "\$$ ./$(BIN) teste_sem_exit.pf"
	@./$(BIN) teste_sem_exit.pf; echo "codigo de saida: $$?   (esperado: 0)"
	@echo ""
	@echo "=========================================================="
